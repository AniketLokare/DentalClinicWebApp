...
export const rolesAllowedRoutes = {
  ...
  RECEP: [DASHBOARD_PATH, APPOINTMENTS, NEW_APPOINTMENT_PATH, VIEW_APPOINTMENT_PATH,
    VIEW_PATIENT_PATH,
    SALES_ORDERS,
    NEW_SALES_PATH,
    VIEW_SALE_PATH,
    ...
    VIEW_SALES_TRANSACTIONS_PATH,
    NEW_SALES_TRANSACTIONS_PATH,
    PATIENTS, MEDICINES, NEW_MEDICINE_PATH,PURCHASE_ORDERS,NEW_PURCHASE_PATH,VIEW_PURCHASE_PATH,PURCHASE_TRANSACTIONS,
    NEW_PURCHASE_TRANSACTIONS_PATH, PURCHASE_TRANSACTIONS,VIEW_PURCHASE_TRANSACTIONS_PATH,
    PROCEDURES, APPOINTMENT_BYDATE_PATH,
