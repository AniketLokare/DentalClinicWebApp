...
import { WARNING_ORANGE} from 'src/constants/colors';
  ...
  const { response, isLoading, isError } = useGetProceduresList({
    ...
    useEffect(() => {
        ...
        procedures.forEach((procedure: any) => {
          ...
          const finalAmount = Number(procedure.discount) || 0; // Ensure finalAmount is a valid number
        ...
        setTotalDiscount(`₹${currentMonthTotal.toLocaleString()}`);
